...
public abstract class CreationCard {
    ...
    public static List<DevelopmentCard>  createCardList(){
         ...
         List<List<Effect>> immediateEffectGreenList = new ArrayList<>();
        List<Effect> immediateEffectGreen1= new ArrayList<>();
        immediateEffectGreenList.add(0,null);

         List<Effect> immediateEffectGreen2= new ArrayList<>();
         ResourceList resourceList2 = new ResourceList();
         resourceList2.addSpecificResource(new Wood(1));
         immediateEffectGreen2.add(new GetResource(resourceList2));
         immediateEffectGreenList.add(1,immediateEffectGreen2);
