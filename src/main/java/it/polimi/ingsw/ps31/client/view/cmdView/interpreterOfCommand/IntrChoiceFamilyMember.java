 ...
 *
 *  Interprete dei comandi relativo alla scelta del family member da utilizzare
 *
 *  @see VCFamilyMemberChoice
 */
public class IntrChoiceFamilyMember implements CmdInterpreterView {
    @Override
