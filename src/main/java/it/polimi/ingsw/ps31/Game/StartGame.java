...
public class StartGame {
    ...
    public void playGame() {
      ...
      //  int[] bonusVictoryPointFromMilitaryTrack = jsonObjectReadFromFile.getBonusVictoryPointFromMilitaryTrack();
    ...
    public void finalExtraVictoryPoints4() {
        ...
        for(int i=0;i<playerList.size();i++) {
            if (playerList.get(0).getResources().getResource("MilitaryStrength").getValue()== playerList.get(i).getResources().getResource("MilitaryStrength").getValue()) {
                contatore++;
              //  playerList.get(i).getResources().getResource("MilitaryStrength").addValue(bonusVictoryPointFromMilitaryTrack[0]);
            }
        ...
        for(int j=1;j<playerList.size();j++){
            if (paritàTrovata=false && playerList.get(1).getResources().getResource("MilitaryStrength").getValue()== playerList.get(j).getResources().getResource("MilitaryStrength").getValue()) {
                contatore2++;
              //  playerList.get(j).getResources().getResource("MilitaryStrength").addValue(bonusVictoryPointFromMilitaryTrack[1]);
            }
        }
        if (contatore2>1){
            paritàTrovata = true;
